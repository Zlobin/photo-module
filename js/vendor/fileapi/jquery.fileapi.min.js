...
(function ($, api){
	...
	var Plugin = function (el, options){
		...
		this.options  = { // current options
			...
			imageOriginal: true,
			imageTransform: 0,
			imageAutoOrientation: !!api.support.exif,
	...
	$.fn.webcam = function (options){
		...
		if( inst === true ){
			...
			api.Camera.publish($el, options, function (err, cam){
					...
					_each(['onSelect', 'onChange'], function (name, fn){
						if ( fn = opts[name] ) {
							opts[name] = function (coords) {
								var
									  flip = deg % 180
									, ow = info.width || img.width
									, oh = info.height || img.height
